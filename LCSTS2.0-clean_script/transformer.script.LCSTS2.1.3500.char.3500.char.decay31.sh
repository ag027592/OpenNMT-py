TITLE="20180505_3500_char_3500_char_transformer_decay31"
...
DATA_DIR="/home/playma/data/"$PROGRAM"/"$DATASET"/"$METHOD"_data-bin_3500_char_3500_char"
MODEL_DIR="/2t/playma/model/"$PROGRAM"/"$DATASET"/"$METHOD"_checkpoints/"$TITLE
MODEL_NAME="_acc_58.82_ppl_11.35_e23.pt"
