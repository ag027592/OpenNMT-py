TITLE="20180424_3500_char_3500_char_transformer"
DATASET="LCSTS"
ENC_TYPE="char"
DEC_TYPE="char" 
...
DATA_DIR="/4t/playma/lily_model/"$METHOD"_data-bin_3500_char_3500_char"
MODEL_DIR="/4t/playma/lily_model/"$TITLE
MODEL_NAME="_acc_63.67_ppl_6.48_e18.pt"
#TEST=$ORIGIN_DIR"/test.source"
TEST="/4t/playma/dataset/LCSTS2.1/char_char_data/test.source"
PRED_DIR=$MODEL_DIR"/pred_result"
PRED=$PRED_DIR"/"$MODEL_NAME
#GOLD=$ORIGIN_DIR"/test.target"
GOLD="/4t/playma/dataset/LCSTS2.1/char_char_data/test.target"
